...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchCourseDetails = async () => {
      try {
        const url = `https://44qf0igih4.execute-api.us-east-1.amazonaws.com/test/course?courseID=${courseID}`;
  ...
  return (
    <div className="container">
      <h1 className="mt-5 mb-4">Data Science {courseDetails && courseDetails.name}</h1>
      {courseDetails && (
        <div>
